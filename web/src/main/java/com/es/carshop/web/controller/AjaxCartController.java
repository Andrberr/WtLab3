package com.es.carshop.web.controller;
...
public class AjaxCartController {
    ...
    @ResponseBody
    public CartAddDto addcar(@RequestBody @Valid CartItemDto cartItem,
                               BindingResult bindingResult) {
        CartAddDto message = new CartAddDto();
        if (!bindingResult.hasErrors()) {
            cartService.addcar(cartItem.getcarId(), cartItem.getQuantity());
        ...
        message.setcarId(cartItem.getcarId());
