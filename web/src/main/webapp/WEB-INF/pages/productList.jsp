...
<tags:master pageTitle="Phohe List">
  ...
  <div class="row">
    <div class="container">
      ...
      <div class="container">
        Found <c:out value="${numberOfcars}"/> cars.
      </div>
    </div>
  </div>
  <div class="panel"></div>
      ...
      <table class="table table-hover table-bordered text-center">
        ...
        <c:forEach var="car" items="${cars}">
          <tr>
            ...
            <td class="align-middle">
              <a href="<c:url value="/productDetails/${car.id}"/>">${car.brand}</a>
            </td>
            <td class="align-middle">
              <a href="<c:url value="/productDetails/${car.id}"/>">${car.model}</a>
            </td>
            <td class="align-middle">
              <ul>
            ...
            <td class="align-middle">${car.displaySizeInches}"</td>
