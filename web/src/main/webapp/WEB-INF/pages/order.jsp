            ...
            <table class="table table-bordered text-center">
                ...
                <c:forEach var="item" items="${order.orderItems}">
                    <tr>
                        ...
                        <td class="align-middle">
                            <ul>
                                <c:forEach var="color" items="${item.car.colors}">
                                    <li>${color.code}</li>
                                </c:forEach>
                            </ul>
                        </td>
                        <td class="align-middle">
                                ${item.car.displaySizeInches}"
                        </td>
                        <td class="align-middle">
                                ${item.quantity}
                        </td>
            ...
            <frm:form method="post" modelAttribute="orderDto" action="${pageContext.servletContext.contextPath}/order">
                <table class="table-borderless">
                    ...
                    <tr>
                        ...
                        <td>
                            <frm:input path="contactcarNo" placeholder="+123456789012"/>
                            <p class="text-danger"><frm:errors path="contactcarNo"/></p>
                        </td>
                    </tr>
                </table>
