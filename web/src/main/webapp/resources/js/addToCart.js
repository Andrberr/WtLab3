function addToCart(carId) {
    const quant = document.querySelector("#quantity" + carId);
    const quantityErrorStatus = document.querySelector("#statusMessage" + carId);
    ...
    $.ajax({
        ...
        data: JSON.stringify({carId, quantity : quant.value}),
        dataType: "json",
