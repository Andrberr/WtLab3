...
import com.es.carshop.web.controller.pages.CartPageController;
...
public class CartPageControllerTest {
    ...
    void testDeleteFromCart() {
        ...
        String viewName = cartPageController.deleteFromCart(carId, mock(Model.class));

        assertEquals("cart", viewName);
        verify(cartService, times(1)).remove(carId);
    }
}
